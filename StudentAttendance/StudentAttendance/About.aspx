<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="StudentAttendance.About" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>--%>
            ...
            <div class="row" style="text-align: center;">
                <asp:Button ID="btngeneratereport" runat="server" Text="Generate Report" class="btn btn-primary" OnClick="btngeneratereport_Click" OnClientClick="jsfunction(); return false;" />
            </div>
            <br />
            <div class="row">
            ...
            <br />
            <div class="row">
                <asp:GridView ID="grdDetailReport" runat="server"></asp:GridView>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
