<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="GenderReport.aspx.cs" Inherits="StudentAttendance.GenderReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        <h3 class="login-sec">Gender Report</h3>
    </div>
                    ...
                    <div style="height: 30px; width: 100%; margin: 0; padding: 0">
                        <table rules="all" border="1" id="tblHeader"
                            ...
                            <tr>
                                ...
                                <td style="width: 22px; text-align: left; font-weight: 600;">Gender</td>
                    ...
                    <asp:Panel ID="Panel1" runat="server" Height="300px" ScrollBars="Vertical">
                        <asp:GridView ID="grdDetailReport" runat="server" Width="1000%" CssClass="auto-style1" ShowHeader="false" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundField DataField="Gender" HeaderText="Gender" ItemStyle-Width="55px" />
